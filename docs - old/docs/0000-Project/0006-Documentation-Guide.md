...
- **[0000-Overview.md](0000-Overview.md)** — Elysium is a handcrafted MMORPG built on the Minecraft engine (used purely as rendering/physics/networking, not as a survival sandbox). Players pick a race, class, and faction and explore a world fractured by a cataclysm 800 years ago. Defines the target audience and states that `docs/` is the full GDD.
- **[0001-Vision.md](0001-Vision.md)** — The founding philosophy: Minecraft is the engine, Elysium is the experience. Lists which vanilla mechanics are removed/restricted/replaced (mining, Elytra, TNT, villagers, etc.), the handcrafted-world philosophy, city/continent scale targets, and the "I forgot I was playing Minecraft" success test.
...
- **[0116-World-Generation.md](../0100-World/0116-World-Generation.md)** — States explicitly that Elysium uses zero runtime procedural generation. Details the offline WorldPainter-based production pipeline from concept sketch to locked, versioned world template, and the few controlled exceptions (dungeons, events, housing).
...
- **[0400-Game-Mechanics.md](../0400-Gameplay/0400-Game-Mechanics.md)** — Broad mechanics overview: MMORPG-first design philosophy, ability-based combat, the default WASD + QERT/Tab/1-2 control scheme, the ultimate-ability energy system, class movement abilities (Alt), the custom inventory/character UI (replacing vanilla), and key rebinding.
...
- **[0408-Physics-Systems.md](../0400-Gameplay/0408-Physics-Systems.md)** — How Minecraft's physics substrate is customized for MMORPG combat/traversal: server authority, no sequence-breaking, and customized falling/knockback/mount/swimming/projectile behavior.
...
The launcher, mods, resource pack, audio/visual presentation, controls, and every UI surface.

- **[1100-Launcher.md](../1100-Client/1100-Launcher.md)** — Custom Python/PyQt6 desktop launcher handling one-click install (Fabric, mods, resource pack), auto-updates, account login, and patch-note display.
- **[1101-Client-Mods.md](../1100-Client/1101-Client-Mods.md)** — The curated Fabric mod bundle (custom UI framework, performance optimization, immersion mods, accessibility mods) installed and versioned as one unit via the launcher.
- **[1102-Resource-Pack.md](../1100-Client/1102-Resource-Pack.md)** — Scope of the custom resource pack: block/terrain retexturing, custom item/mob models, sound design, and UI art replacing all vanilla Minecraft assets.
...
- **[1105-Shaders.md](../1100-Client/1105-Shaders.md)** — Custom shader pack for lighting/weather/water/post-processing, tiered performance presets, and a reduced-effects accessibility mode.
...
- **[1109-Settings.md](../1100-Client/1109-Settings.md)** — The full settings persistence system across controls, graphics, shaders, audio, UI, gameplay, accessibility, account, privacy, and performance, with account-level storage and cross-instance sync rules.
...
- **[1113-Client-Optimisation.md](../1100-Client/1113-Client-Optimisation.md)** — Cross-cutting performance work (rendering, entity caps, UI efficiency, tiered shaders) to keep min-spec hardware playable.
...
- **[1117-Dialogue-UI.md](../1100-Client/1117-Dialogue-UI.md)** — Structured NPC conversation UI (name/title/portrait, response options, quest controls) replacing vanilla chat interaction.
...
- **[1200-Plugin-Architecture.md](../1200-Technical/1200-Plugin-Architecture.md)** — The server runs on Paper (Java) as modular plugins (elysium-core, -combat, -quests, -economy, -social, -pvp) sharing a core library and communicating via an event bus, all persisting through PostgreSQL.
...
- **[1202-Network.md](../1200-Technical/1202-Network.md)** — Networking architecture: Minecraft protocol over Paper, auxiliary services (launcher backend, website/account services, economy APIs), horizontal scalability, and security coordination.
...
- **[1208-Performance.md](../1200-Technical/1208-Performance.md)** — Server- and client-side performance targets and strategy (instance isolation, DB caching, tiered shaders, asset budgets) with load testing planned for Closed Beta.
...
- **[1210-World-Management.md](../1200-Technical/1210-World-Management.md)** — Engineering reference for the handcrafted-world pipeline: WorldPainter terrain workflow, flat base world concept, mountains/floating islands/underground handling, dungeon world templates, region/city management, world protection rules (removed vanilla systems), continent sizes, chunk management, and backups.
...
- **[1305-Textures.md](../1300-Art/1305-Textures.md)** — Texture resolution standard, regional texture sets matching each continent's material language, and the rule against unmodified vanilla textures in player-facing zones.
...
- **[1401-Coding-Standards.md](../1400-Development/1401-Coding-Standards.md)** — Java/Gradle/Paper tooling, style enforcement via CI, modularity within the plugin architecture, server-authority requirement, and shared data-access-layer rule.
...
- **[1405-Naming-Conventions.md](../1400-Development/1405-Naming-Conventions.md)** — Naming standards across code (Java conventions, `elysium-` plugin prefix), in-world content (regions, NPCs, items), and asset files.
...
- **[1410-Developer-Environment.md](../1400-Development/1410-Developer-Environment.md)** — Standard local engineering setup (JDK/Gradle/Paper dev server/DB/IDE config) to minimize environment drift.
