...
Player-facing bug report handling and handoff to development triage.
...
Detailed SOPs are expanded as the project approaches Closed Beta and Live Service. This document establishes ownership and intent for **Bug Reports**.
