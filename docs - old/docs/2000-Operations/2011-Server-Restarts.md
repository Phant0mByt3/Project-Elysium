...
Scheduled and emergency restart procedures and player communication.
...
Detailed SOPs are expanded as the project approaches Closed Beta and Live Service. This document establishes ownership and intent for **Server Restarts**.
