...
Strategies and metrics focused on keeping players returning over time.
...
Detailed SOPs are expanded as the project approaches Closed Beta and Live Service. This document establishes ownership and intent for **Player Retention**.
