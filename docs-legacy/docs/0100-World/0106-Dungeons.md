...
## Launch Dungeon List (Aurelia & Vethmoor)
...
Bosses, mechanics, and loot for each dungeon are expanded during Phase 3 world-building ([0003-Roadmap.md](../0000-Project/0003-Roadmap.md)). Endgame instances are covered separately in [0107-Raids.md](0107-Raids.md).
