...
Public rules for player behaviour in game and official spaces.
...
Detailed SOPs are expanded as the project approaches Closed Beta and Live Service. This document establishes ownership and intent for **Community Guidelines**.
