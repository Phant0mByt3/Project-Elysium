...
See [111-Client-Mods.md](111-Client-Mods.md) for what the launcher installs, and [124-Authentication.md](124-Authentication.md) for the account system it authenticates against.
