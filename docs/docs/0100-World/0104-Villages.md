...
## Purpose
Where cities ([0103-Cities.md](0103-Cities.md)) serve major hub functions, villages exist to:
...
* At least one quest hub tied to the region's "local conflict" (see [0102-Regions.md](0102-Regions.md) template).
