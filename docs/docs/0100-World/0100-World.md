...
* **Overworld** — continuous, open, shared world where exploration, world events, and world bosses happen.
* **Instances** — dungeons ([0106-Dungeons.md](0106-Dungeons.md)) and raids ([0107-Raids.md](0107-Raids.md)), private per group.
...
## See Also
[0200-Lore.md](../0200-Lore/0200-Lore.md) for the history and mythology behind the world's current state, and [0201-Timeline.md](../0200-Lore/0201-Timeline.md) for the chronological account of the Sundering.
