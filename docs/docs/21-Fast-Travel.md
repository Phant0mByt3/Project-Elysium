...
## Overview
Fast travel systems unlock progressively as players explore, rewarding exploration (Pillar 1, [02-Core-Pillars.md](02-Core-Pillars.md)) rather than being available from the start.
...
## Flight Routes
NPC-piloted flight paths connecting major cities and key waypoints, more befitting the fantasy tone for cross-continent travel. Distinct from the future player-flying-mount system noted in [91-Mounts.md](91-Mounts.md).
...
* Newly discovered shrines in contested Vethmoor territory can be temporarily locked by faction control shifts — see [86-Territory-Control.md](86-Territory-Control.md).
