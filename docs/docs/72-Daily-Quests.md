...
* No daily quest should be mandatory for raid or dungeon readiness — they should be a supplementary, optional grind for players who want extra progression, per Pillar 5 in [02-Core-Pillars.md](02-Core-Pillars.md).
* Daily quest hubs should be tied to a specific faction reputation track ([77-Factions-Reputation.md](77-Factions-Reputation.md)) or profession ([60-Professions.md](60-Professions.md)) to give them thematic purpose beyond pure repetition.
...
See [73-Weekly-Quests.md](73-Weekly-Quests.md) for the larger-reward, lower-frequency counterpart to this system.
