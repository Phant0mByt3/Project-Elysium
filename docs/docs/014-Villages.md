...
## Purpose
Where cities ([13-Cities.md](13-Cities.md)) serve major hub functions, villages exist to:
...
* At least one quest hub tied to the region's "local conflict" (see [12-Regions.md](12-Regions.md) template).
...
Villages are cross-referenced from their parent region entries in [12-Regions.md](12-Regions.md) and should never duplicate content covered by nearby landmarks ([15-Landmarks.md](15-Landmarks.md)).
