...
## Planned Features
* **Colorblind Modes** — alternate palettes for status effects ([47-Status-Effects.md](47-Status-Effects.md)), faction UI elements, and loot rarity colors ([53-Loot.md](53-Loot.md)).
...
## Design Rules
Accessibility options should be reviewed alongside every major UI or combat-effects feature added to the game, not bolted on as a single late-stage pass — consistent with the "documentation and quality are part of development" pillars in [02-Core-Pillars.md](02-Core-Pillars.md).
