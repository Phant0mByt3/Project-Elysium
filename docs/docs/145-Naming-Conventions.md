...
## In-World Content
* **Regions/Zones** — Descriptive two-word names reflecting theme (e.g. "Wildwood Reach," "Ashenclaw Tundra") consistent with [012-Regions.md](012-Regions.md).
* **NPCs** — First name + optional epithet/title reflecting culture ([034-Races.md](034-Races.md)); avoid duplicate first names within the same region without a distinguishing surname.
* **Items** — Rarity-appropriate flavor: Common/Uncommon items use plain descriptive names; Legendary/Relic items use evocative named-artifact conventions (see [055-Legendary-Items.md](055-Legendary-Items.md), [056-Relics.md](056-Relics.md)).
