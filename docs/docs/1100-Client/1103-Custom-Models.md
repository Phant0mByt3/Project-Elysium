...
## Pipeline
Models are produced by the art team following the standards in [1300-Art-Style.md](../1300-Art/1300-Art-Style.md) and [1306-Models.md](../1300-Art/1306-Models.md), then integrated into the resource pack for distribution via the launcher.
