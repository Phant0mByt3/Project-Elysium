...
## Overview
Accessibility features spanning the client moduleules ([1101-Client-Modules.md](1101-Client-Modules.md)), rendering effects ([1105-Rendering Effects.md](1105-Rendering Effects.md)), and UI ([1301-UI-Style.md](../1300-Art/1301-UI-Style.md)) to make Elysium playable by as wide an audience as possible.
...
* **Reduced Effects Mode** — a post-process/particle-density toggle for photosensitivity and lower-end hardware performance, extending [1105-Rendering Effects.md](1105-Rendering Effects.md)'s tiered presets.
