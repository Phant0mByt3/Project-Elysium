...
* **Reduced Effects Mode** — a shader/particle-density toggle for photosensitivity and lower-end hardware performance, extending [1105-Shaders.md](1105-Shaders.md)'s tiered presets.
