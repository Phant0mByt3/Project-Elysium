...
- **[1105-Rendering Effects.md](../1100-Client/1105-Rendering Effects.md)** — Custom rendering pipeline for lighting/weather/water/post-processing, tiered performance presets, and a reduced-effects accessibility mode.
