...
## Overview
The process for shipping a new patch or content update to Elysium, from code-complete to live, applicable from Closed Alpha ([03-Roadmap.md](03-Roadmap.md)) onward.
...
4. **Patch Notes** — written and added to [04-Version-History.md](04-Version-History.md), summarizing additions, changes, fixes, and removals.
...
## Cadence
Regular minor patches (balance, bug fixes) on a predictable cycle; major content patches (new dungeons, raids, story chapters) on a longer cycle aligned with the roadmap ([03-Roadmap.md](03-Roadmap.md)) and seasonal calendar ([87-Seasons.md](87-Seasons.md)).
