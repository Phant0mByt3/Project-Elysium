...
## Philosophy
Balance in Elysium is treated as an ongoing process, not a pre-launch checkbox. This document tracks the standards and cadence for balance work, not specific number values (which belong in version-specific patch notes, [004-Version-History.md](004-Version-History.md)).
...
* PvP and PvE balance are tuned somewhat independently where needed — see [084-PvP.md](084-PvP.md) for PvP-specific modifiers.
...
## Escalation
Significant balance changes (talent reworks, specialization identity shifts) should be documented as deliberate design decisions in [004-Version-History.md](004-Version-History.md), not silently patched.
